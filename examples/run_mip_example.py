...
# Suppress TensorFlow logging and warnings before importing it
...
if __name__ == '__main__':
    print("⏳ Loading FILM model...", flush=True)
    ...
    print(f"   Interpolated volume shape: {interpolated_volume.shape}", flush=True)

    print("📊 Performing Maximum Intensity Projection...", flush=True)
    # Calculate MIP for start, middle, and end volumes
