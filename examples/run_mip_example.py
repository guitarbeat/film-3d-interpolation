import os
# Suppress TensorFlow logs to keep the CLI clean
...
if __name__ == '__main__':
    # Initialize with a friendly status
    print("🎨 Initializing FILM 3D Interpolator... (this might take a moment)")
    ...
    print("📊 performing Maximum Intensity Projections (MIP) for comparison...")
    # Compute MIPs for all volumes
    ...
    axes[1].set_title("Interpolated Volume MIP (t=0.5)")
    axes[1].axis('off')
    ...
    print(f"🖼️  Saved comparison image to {out_path}")
