...
if __name__ == '__main__':
    ...
    print("⏳ Interpolating 3D volumes... (this might take a moment)")
    ...
    # Calculate MIP for start, interpolated, and end volumes for comparison
    ...
    print(f"📏 MIP image shape: {mip_interp.shape}")
